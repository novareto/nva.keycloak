...
#
#  $ bin/test -s nva.keycloak -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src nva.keycloak.testing.NVA_KEYCLOAK_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/nva/keycloak/tests/robot/test_example.robot
#
