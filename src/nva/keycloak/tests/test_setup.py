...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("nva.keycloak"))
    ...
    def test_browserlayer(self):
        ...
        self.assertIn(INvaKeycloakLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("nva.keycloak"))
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(INvaKeycloakLayer, utils.registered_layers())
